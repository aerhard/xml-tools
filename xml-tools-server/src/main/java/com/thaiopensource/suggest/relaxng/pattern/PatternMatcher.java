...
public class PatternMatcher implements Cloneable, Matcher {
  ...
  private static void appendAttributeValue(StringBuilder buf, String value) {
    buf.append('"');
  ...
  public NormalizedSuggestions getStartTagSuggestions() {
    return new PossibleStartTagNameSuggestionsFunction().applyTo(memo.getPattern());
  }

  public NormalizedSuggestions getAttributeNameSuggestions() {
    return new PossibleAttributeNameSuggestionsFunction().applyTo(memo.getPattern());
  }
